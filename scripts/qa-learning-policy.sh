...
# Post-Phase-2U.5 baseline; update only after an approved data checkpoint.
EXPECTED_TOTAL_TRANSACTIONS=1027
EXPECTED_MANUALLY_APPROVED=663
EXPECTED_NEEDS_REVIEW=363
EXPECTED_AUTO_CLASSIFIED=1
